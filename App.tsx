...
import { KoydumProvider, useKoydum } from './src/state/KoydumContext';
...
function Root() {
  const { booting, screen, showOnboarding, selected, addOpen, moveOpen, voiceTarget, paywall } = useKoydum();
