    ...
    <View style={styles.scrim}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ width: '100%' }}>
        <SafeAreaView edges={['bottom']} style={styles.sheet}>
          <Text style={styles.title}>Nereye koydun?</Text>
          <Text style={styles.hint}>Yeni yerini kaydedersen tekrar bulman daha kolay olur.</Text>
          ...
          <View style={styles.actions}>
            <SecondaryButton label="Konumu değiştirmeden kapat" onPress={() => markFound(false)} style={{ flex: 1 }} />
          </View>
          <PrimaryButton
            label="Bulundu olarak işaretle"
